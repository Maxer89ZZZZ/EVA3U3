...
namespace MercDevs_ej2.Controllers
{
    public class DatosfichatecnicasController : Controller
    {
        ...
        public async Task<IActionResult> FichaTecnica(int? id)
        {
            ...
            if (datosFichaTecnica.FechaInicio == null || datosFichaTecnica.FechaFinalizacion == null ||
                (datosFichaTecnica.FechaFinalizacion - datosFichaTecnica.FechaInicio).Value.TotalDays < 5)
            {
                ViewData["ErrorMessage"] = "La fecha de inicio debe ser al menos 5 días antes que la fecha de finalización.";
            }
